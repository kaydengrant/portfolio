    ...
    <>
      ...
      >
        ...
        <div className='flex flex-col items-center md:flex-row justify-around gap-8'>
          <animated.div
            style={slideLeftAnim}
            className='flex flex-col justify-center md:max-w-[60%] text-left md:mt-0 gap-4'
          >
            <p>
            ...
            <ul>
              ...
              <li className='flex flex-row gap-4'>
                ...
                <p>
                  Expecting to graduate from the University of Washington with a
          ...
          <animated.div style={slideRightAnim} className='hidden md:flex'>
            <ShuffleEmoticon />
          </animated.div>
        </div>
      </animated.section>
